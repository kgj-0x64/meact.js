...
const renderTree = {
  ...
  addEffectToQueue(effectObject) {
    ...
    console.log(
      "addEffectToQueue this.useEffectQueue.length",
      this.useEffectQueue.length,
      JSON.stringify(this.useEffectQueue) // Log stringified version
    );
  },
  /**
  ...
  getLastEffectFromQueue() {
    console.log(
      "getLastEffectFromQueue this.useEffectQueue",
      JSON.stringify(this.useEffectQueue)
    );
