...
const renderTree = {
  ...
  rerenderDiffForDomHandler: {
    queue: [], // {{action: "created" | "updated", parentElementId: string, targetElement: MeactElement, childPosition: number}[]}
    /**
     * @param {{action: "created" | "updated", parentElementId: string, targetElement: MeactElement, childPosition: number}} elementSnapshot
     */
