...
function createElement(name, props, ...children) {
  ...
  if (typeof name === "function") {
    console.log("createElement", name.name, children);
    // add children, if any, into props
    let propsWithChildren = props ? props : {};
    propsWithChildren = {
      ...propsWithChildren,
      children,
    };
    ...
    console.log("component for", name.name, component);
    return component;
  }

  console.log("createElement", name, children);
  ...
  const element = new MeactElement(name, props, childrenElements);
