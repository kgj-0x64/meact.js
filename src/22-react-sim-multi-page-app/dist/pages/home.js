var home = (() => {
  ...
  var { createElement: createElement4 } = meact_default;
  function TodoListContainer({ todos: todos2 }) {
    ...
    return createElement4(
      "div",
      null,
      createElement4("button", { onClick: () => setTab("all") }, "All"),
      createElement4("button", { onClick: () => setTab("active") }, "Active"),
      createElement4(
        "button",
