  ...
  constructor(
    ...
    this.effectManager =
      type === "ReactComponent"
        ...
        : undefined;
    // useMemo manager useful for an element of type "ReactComponent"
    this.cacheManager =
      type === "ReactComponent"
        ? {
...
function createElement(element, props, ...children) {
  ...
  if (typeof element === "function") {
    ...
    if (!returnedElement instanceof ReactElement) {
      throw new Error(
        `A functional component must return only one child element`
      );
    }
